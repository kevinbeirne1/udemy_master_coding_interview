...
describe('breadthFirstSearchIterative ', () => {
    ...
    context('Tree Traversal', () => {
        ...
        it('should return an empty list for empty tree', () => {
            let actual = JSON.stringify(this.tree.BFSRecursive());
        ...
        it('should return the root in a single item tree', () => {
            ...
            let actual = JSON.stringify(this.tree.BFSIterative())
        ...
        it('should return a list for 4 item tree', () => {
            ...
            this.tree.populateTree(values)
            let actual = JSON.stringify(this.tree.BFSIterative())
            let expected_output = JSON.stringify([4, 2, 6, 1])
            expect(actual).to.equal(expected_output)
        })
        ...
        it('should return a list for 7 item tree', () => {
            ...
            this.tree.populateTree(values)
            let actual = JSON.stringify(this.tree.BFSIterative())
            let expected_output = JSON.stringify([9, 4, 20, 1, 6, 15, 170])
            expect(actual).to.equal(expected_output)
        })
    })
})

describe('breadthFirstSearchRecursive ', () => {
